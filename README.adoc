...
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/data-sources/service[kubernetes_service.apisix] (data source)
...
|[[input_replicas]] <<input_replicas,replicas>>
|Number of replicas for the apisix instance.
|`number`
|`1`
|no
...
|[[output_external_ip]] <<output_external_ip,external_ip>> |External IP address of APISIX LB service.
|===
// END_TF_TABLES
====
